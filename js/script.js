...
//função que adiciona um novo elemento à lista de tarefas ao clicar no botão "+"
//o novo elemento não será adicionado caso seja vazio
...
//ao pressionar a tecla "Enter" um novo elemento é adicionado à lista de tarefas
//o novo elemento não será adicionado caso seja vazio
var input = document.getElementById("item-text");
...
//função que carrega a lista de atividades
function loadItens() {
...
//função que cria um novo item na lista de atividades
//incluído os botões de excluir e concluído
//parâmetros de entrada: uma string com a atividade a ser realizada 
//e um binário com seu status - concluído e não concluído
...
//função que remove um item da lista de atividades
//incluído os botões de excluir e concluído
function removeItem(){	
...
//função para alternar o status de uma atividade entre concluída e não concluída
